...
| `domain_hint`   | The `domain_hint` parameter for the OpenID Connect authentication request.                                                                                | Opaque value that is passed through as-is. Provides a hint for the OP to determine which Tenant to present to the user to authenticate to. See [OpenID Connect Enterprise Extensions](https://openid.net/specs/openid-connect-enterprise-extensions-1_0.html). |
