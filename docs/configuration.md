...
| `upstream.dpop`                    | boolean  | `false`              | Send DPoP-bound access tokens to the upstream with the `DPoP` authorization scheme and a fresh proof instead of as Bearer tokens. See [DPoP](dpop.md#upstream-presentation).                                                                                                       |
