...
| `openid.dpop`                      | boolean  | `false`              | Use DPoP for identity-provider token requests and authenticated upstream requests. Requires `openid.client-jwk`, compatible provider support, and a DPoP-aware upstream. See [DPoP](dpop.md).                                                                                      |
...
| `upstream.access-logs`             | boolean  | `false`              | Enable access logs for upstream requests.                                                                                                                                                                                                                                          |
...
The old `upstream-*` command-line flags remain available as deprecated aliases.
Use the dotted `upstream.*` flags for new configurations.
